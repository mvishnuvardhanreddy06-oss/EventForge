...
import { Clock, SearchX, Plus, RotateCcw } from 'lucide-react';

export const NoSessionsState = ({ onAddSession }) => {
  return (
    <div className="bg-white rounded-3xl border border-slate-200/80 p-12 text-center shadow-2xs max-w-xl mx-auto my-8 space-y-4">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
          Build your event agenda by adding sessions, speakers and rooms.
        </p>
      </div>
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200/80 p-12 text-center shadow-2xs max-w-xl mx-auto my-8 space-y-4">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-slate-500 max-w-sm mx-auto leading-relaxed">
          Try changing your search or filters to locate specific agenda items.
        </p>
      </div>
...
export default { NoSessionsState, NoSearchResultsState };
